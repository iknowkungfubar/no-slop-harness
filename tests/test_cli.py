...
class TestCLIReport:
    ...
    def test_success(self, mock_load, runner: CliRunner) -> None:
        mock_load.return_value = {"request_id": "rpt", "tasks": {"task1": {"description": "T"}}}
    ...
    def test_failure(self, mock_load, runner: CliRunner) -> None:
        mock_load.return_value = {"request_id": "fail", "tasks": {"task1": {"description": "T"}}}
...
class TestCLIVerify:
    ...
    @mock.patch("no_slop_harness.cli._load_state")
    def test_pass(self, mock_load, runner: CliRunner) -> None:
        mock_load.return_value = {
            "request_id": "vfy",
    ...
    @mock.patch("no_slop_harness.cli._load_state")
    def test_fail(self, mock_load, runner: CliRunner) -> None:
        mock_load.return_value = {"request_id": "vfy2", "tasks": {"t1": {"description": "T"}}}
