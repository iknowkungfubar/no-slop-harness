...
### Fixed
- README: Removed "Not yet on PyPI" claim — package IS published on PyPI at 0.9.0. Replaced with accurate PyPI install instructions.
- README: AGENTS.md reference was a broken link; now resolved with actual file.

### Added
- `AGENTS.md`: Agent operating rules for AI agent interaction with the repository (rules, file conventions, CI commands).
