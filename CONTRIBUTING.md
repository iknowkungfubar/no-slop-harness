...
74|
75|```bash
76|git clone https://github.com/iknowkungfubar/no-slop-harness.git
77|cd no-slop-harness
...
233|## Questions?
234|
235|Open a [Discussion](https://github.com/iknowkungfubar/no-slop-harness/discussions) or an [Issue](https://github.com/iknowkungfubar/no-slop-harness/issues) with a clear description of what you need help with.
236|
237|---
238|
